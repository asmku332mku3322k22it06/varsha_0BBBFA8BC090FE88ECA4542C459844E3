''' Implement a class called Player that represents a cricket player.The Playyeerclass should have a''' Implement a class called Player that represents a cricket player.The Playyeerclass should have a
...
Btsman and Bowler classes and call the play() methid for each object.'''
